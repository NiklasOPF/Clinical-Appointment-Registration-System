...
public class MainKiosk {
    ...
    private static PatientSessionBeanRemote patientSessionBeanRemote; //TODO theres no need to do dep̴endency injection here since we don't need it right now, we might not even need it in the MainAppKisok module. Therefore it's better to wait and do a JNDI lookup when we actually need the bean. JNDI also allows the client to be in a separate JVM from the ejb
    ...
    public static void main(String[] args) {
        ...
        new MainAppKisok(doctorSessionBeanRemote, staffSessionBeanRemote, patientSessionBeanRemote, appointmentSessionBeanRemote, queueSessionBeanRemote);
    }
